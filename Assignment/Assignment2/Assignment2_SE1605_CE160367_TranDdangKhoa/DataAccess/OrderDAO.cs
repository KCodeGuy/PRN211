    ...
    public class OrderDAO : BaseDAL
    {
        ...
        public void AddNew(OrderObject order)
        {
            try
            {
                ...
                if (mo == null)
                {
                    string SQLInsert = "Insert into Orders values(@MemberID,@OrderDate,@RequiredDate,@ShippedDate,@Freight)";
                    var parameters = new List<SqlParameter>();
        ...
        public void Update(OrderObject order)
        {
            try
            {
                ...
                if (mo != null)
                {
                    string SQLUpdate = "Update Orders set OrderDate = @OrderDate , RequiredDate = @RequiredDate, ShippedDate = @ShippedDate ,Freight= @Freight where OrderID = @OrderID";
                    var parameters = new List<SqlParameter>();
